...
public class BasicNetwork implements Network {
    ...
    public NetworkResponse performRequest(Request<?> request) throws VolleyError {
        ...
        while (true) {
            ...
            List<com.android.volley.toolbox.Header> responseHeaders = new ArrayList<>();
            try {
                // Gather headers.
                List<com.android.volley.toolbox.Header> headers = new ArrayList<>();
    ...
    private static List<com.android.volley.toolbox.Header> convertHeaders(Header[] headers) {
        List<com.android.volley.toolbox.Header> result = new ArrayList<>();
